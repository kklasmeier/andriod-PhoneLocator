...
import com.klasmeier.phonelocator.data.AppSettings
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            PhoneLocatorTheme(themeMode = settings.themeMode) {
                PhoneLocatorAppRoot(settingsRepository = settingsRepository)
            }
        }
    }
}
...
@Composable
private fun PhoneLocatorAppRoot(settingsRepository: SettingsRepository) {
    val context = LocalContext.current
